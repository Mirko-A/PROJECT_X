...
def motion_detector_gist():
    ...
    while True:
        ...
        # 4. Dilute the image a bit to make differences more noticeable; more suitable for contour detection
        kernel = np.ones((5, 5))
        ...
        # cv2.drawContours(image=cur_frame, contours=contours, contourIdx=-1, color=(0, 255, 0), thickness=2, lineType=cv2.LINE_AA)
